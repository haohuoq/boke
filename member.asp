...
%>
	  ...
	  <tr><td align="right" width="85"><strong>　用户名:</strong></td><td align="left" style="padding:3px;"><%=blog_Mem("mem_Name")%></td></tr>
	  ...
	  <tr><td align="right" width="85"><strong>登录密码:</strong></td><td align="left" style="padding:3px;"><input name="password" type="password" size="18" class="userpass" maxlength="16" id="cpassword" onkeyup="istrong()"/> 密码必须是6到16个字符，建议使用英文和符号混合</td></tr>
	  ...
	  <tr><td align="right" width="85"><strong>确认密码:</strong></td><td align="left" style="padding:3px;"><input name="Confirmpassword" type="password" size="18" class="userpass" maxlength="16"/> 必须和上面的密码一样</td></tr>
      <%
