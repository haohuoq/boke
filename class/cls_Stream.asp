...
Class Stream
	...
	Public Function SaveToFile(ByVal strBody, ByVal File)
		Dim RText
		RText = Array(0, Lang.SaveFileFail)
		With c_Stream
			.Type = 2
			.Open
			.Charset = Cset
			...
			.Close
		End With
		RText = Array(1, Lang.SaveFileSuc)
		SaveToFile = RText
	End Function
	...
	Public Function GetHttpPage(ByVal Url, ByVal Types)
		...
		With c_httpXml
			...
			If TypeName(.responseBody) = "Empty" Or TypeName(.responseBody) = "Null" Or Len(.responseBody) = 0 Then
				Rtext = Array(-1, Lang.FileNoContent)
			Else
				If Int(Types) = 0 Then
	...
	Public Function SaveToLocal(ByVal Url, ByVal FilePath)
		...
		If Int(ImgContent(0)) = 0 Then
			With c_Stream
				...
				.Close()
			End With
			RText = Array(0, Lang.SaveFileSuc)
		Else
			RText = Array(-1, Lang.GetFileFail)
		End If
		SaveToLocal = RText
	End Function
