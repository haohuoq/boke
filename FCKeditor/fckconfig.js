...
FCKConfig.ToolbarSets["Basic"] = [
	['Source','Bold','Italic','Underline','StrikeThrough','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','OrderedList','UnorderedList','-','Link','Unlink','-','TextColor','BGColor','Image','Smiley','About']
] ;
...
FCKConfig.FontNames		= 'Arial;Corbel;Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana;宋体;新宋体;黑体;微软雅黑;楷体_GB2312;隶书' ;
FCKConfig.FontSizes		= '8px;9px;10px;11px;12px;14px;16px;18px;20px;24px;26px;28px;32px;36px;48px;smaller;larger;xx-small;x-small;small;medium;large;x-large;xx-large' ;
