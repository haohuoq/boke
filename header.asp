...
Set SkinXML = Nothing
'合作信息
	SkinInfo = SkinInfo & " <a href=""http://www.jinbenli.com"" target=""_blank""><img border=""0"" src=""images/detect.gif"" alt=""期货配资"" style=""margin-bottom:-2px;height:14px;width:12px""/></a>"
End If
End If
End Sub
%>
