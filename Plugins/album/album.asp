...
.xckuang{margin:34px; width:200px; height:200px;float:left; background:url /* 相册列表*/(Plugins/album/images/backimg.gif) no-repeat; padding-top:8px; text-align:center }
.xcclass{  }
.xcclasskuang{margin:10px 45px; width: auto; float:left;  } /* 相册内页*/
